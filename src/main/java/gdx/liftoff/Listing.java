...
import static gdx.liftoff.Maker.makeList;
...
import gdx.liftoff.data.templates.official.ApplicationAdapterTemplate;
import gdx.liftoff.data.templates.official.ApplicationListenerTemplate;
import gdx.liftoff.data.templates.official.ClassicTemplate;
import gdx.liftoff.data.templates.official.EmptyTemplate;
import gdx.liftoff.data.templates.official.GameTemplate;
import gdx.liftoff.data.templates.official.InputProcessorTemplate;
import gdx.liftoff.data.templates.official.IsometricVoxelTemplate;
import gdx.liftoff.data.templates.official.KotlinBasicTemplate;
import gdx.liftoff.data.templates.official.KotlinClassicTemplate;
import gdx.liftoff.data.templates.official.Scene2DTemplate;
import gdx.liftoff.data.templates.official.SuperKoalioTemplate;
import gdx.liftoff.data.templates.unofficial.AutumnMvcBasicTemplate;
import gdx.liftoff.data.templates.unofficial.AutumnMvcBox2dTemplate;
import gdx.liftoff.data.templates.unofficial.AutumnMvcVisTemplate;
import gdx.liftoff.data.templates.unofficial.KiwiInputTemplate;
import gdx.liftoff.data.templates.unofficial.KiwiTemplate;
import gdx.liftoff.data.templates.unofficial.KtxTemplate;
import gdx.liftoff.data.templates.unofficial.LmlTemplate;
import gdx.liftoff.data.templates.unofficial.Noise4JTemplate;
import gdx.liftoff.data.templates.unofficial.VisUIBasicTemplate;
import gdx.liftoff.data.templates.unofficial.VisUIShowcaseTemplate;
